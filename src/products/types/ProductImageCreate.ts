...
export interface ProductImageCreate_productImageCreate_product_location_address_country {
  __typename: "CountryDisplay";
  code: string;
  country: string;
}

export interface ProductImageCreate_productImageCreate_product_location_address {
  __typename: "Address";
  city: string;
  cityArea: string;
  companyName: string;
  country: ProductImageCreate_productImageCreate_product_location_address_country;
  countryArea: string;
  firstName: string;
  id: string;
  lastName: string;
...
export interface ProductImageCreate_productImageCreate_product {
  ...
  location: ProductImageCreate_productImageCreate_product_location | null;
}
