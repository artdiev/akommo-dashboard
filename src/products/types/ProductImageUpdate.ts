...
export interface ProductImageUpdate_productImageUpdate_product_location_address_country {
  __typename: "CountryDisplay";
  code: string;
  country: string;
}

export interface ProductImageUpdate_productImageUpdate_product_location_address {
  __typename: "Address";
  city: string;
  cityArea: string;
  companyName: string;
  country: ProductImageUpdate_productImageUpdate_product_location_address_country;
  countryArea: string;
  firstName: string;
  id: string;
  lastName: string;
...
export interface ProductImageUpdate_productImageUpdate_product_location_product {
  __typename: "Product";
  id: string;
  name: string;
}

export interface ProductImageUpdate_productImageUpdate_product_location {
  __typename: "Location";
  id: string;
  geography: any;
  address: ProductImageUpdate_productImageUpdate_product_location_address;
  product: ProductImageUpdate_productImageUpdate_product_location_product;
}
...
export interface ProductImageUpdate_productImageUpdate_product {
  ...
  location: ProductImageUpdate_productImageUpdate_product_location | null;
}
