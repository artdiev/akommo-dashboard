...
export interface ProductUpdate_productUpdate_product_location_address_country {
  __typename: "CountryDisplay";
  code: string;
  country: string;
}

export interface ProductUpdate_productUpdate_product_location_address {
  __typename: "Address";
  city: string;
  cityArea: string;
  companyName: string;
  country: ProductUpdate_productUpdate_product_location_address_country;
  countryArea: string;
  firstName: string;
  id: string;
  lastName: string;
...
export interface ProductUpdate_productUpdate_product_location_product {
  __typename: "Product";
  id: string;
  name: string;
}

export interface ProductUpdate_productUpdate_product_location {
  __typename: "Location";
  id: string;
  geography: any;
  address: ProductUpdate_productUpdate_product_location_address;
  product: ProductUpdate_productUpdate_product_location_product;
}
...
export interface ProductUpdate_productUpdate_product {
  ...
  location: ProductUpdate_productUpdate_product_location | null;
}
